 ...
 ******************************************************************************
 -- добавлен таймер задержки Т4 при переключении.
 -- добавлена возможность задавать при программировании как g,p так и  G,P.
 */
...
//                   (char*) (call_number + channel_tx), 4); // check!!!!!!!!!!!!!!!!
            ...
            else
            {
                enable_ptt = 1; // это передача
					...
					debounce = 0;  // сброс в нач. состояние
    }
